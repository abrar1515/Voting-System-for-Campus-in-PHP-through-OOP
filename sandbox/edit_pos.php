        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_POST['update'])) {
                    ...
                    $rtnUpdatePos = $updatePos->UPDATE_POS($campus, $position, $position_id);
                }
                ?>
                ...
                <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" role="form">
                    ...
                    <div class="form-group-sm">
                        <label for="campus">Campus</label>
                            ...
                            <select required name="campus" class="form-control">

                                <option value="<?php echo $rowEditPos['camp']; ?>"><?php echo $rowEditPos['camp']; ?></option>
