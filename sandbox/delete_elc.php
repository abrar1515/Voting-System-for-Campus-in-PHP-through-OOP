    ...
    <div class="container">
        <div class="row">
            ...
            if(isset($_GET['id'])) {
                ...
                echo "<div class='alert alert-danger'>Are you sure you want to delete selected election? <a href='http://localhost/voting_system/sandbox/delete_elc.php?del_id=$elc_id'>Yes</a> | <a href='http://localhost/voting_system/sandbox/add_elc.php'>No</a></div>";
            }
            ...
            if(isset($_GET['del_id'])) {
                $id_to_del = $_GET['del_id'];
                    ...
                    $delElc = new Election();
                    $rtnDelElc = $delElc->DELETE_ELECTION($id_to_del);
                }
                ?>
            </div>
        </div>
