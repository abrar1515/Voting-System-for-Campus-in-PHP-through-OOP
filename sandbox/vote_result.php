    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            if(!isset($_GET['campus'])) {
                echo "<div class='alert alert-warning'>Please select Campus and click submit to show vote result.</div>";
            } else {
            $camp = trim($_GET['campus']);
            ?>
                <a href="http://localhost/voting_system/sandbox/print_result.php?campus=<?php echo $camp; ?>"><h3><span class="glyphicon glyphicon-print pull-right"></h3></span> </a>
                <h4><?php echo $camp; ?> Result</h4>
                <hr>

                <?php
                $readPos = new Position();
                $rtnReadPos = $readPos->READ_POS_BY_ORG($camp);
                ?>
                ...
                <?php if($rtnReadPos) { ?>
                    ...
                    <h5><?php echo $rowPos['pos']; ?></h5>
                        ...
                        $rtnReadNomOrgPos = $readNomOrgPos->READ_NOM_BY_ORG_POS($camp, $rowPos['pos']);
                        ?>
