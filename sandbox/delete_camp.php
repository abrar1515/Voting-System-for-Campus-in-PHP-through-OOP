        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                if(isset($_GET['id'])) {
                    ...
                    echo "<div class='alert alert-danger'>Are you sure you want to delete selected Campus? <a href='http://localhost/voting_system/sandbox/delete_camp.php?del_id=$camp_id'>Yes</a> | <a href='http://localhost/voting_system/sandbox/add_camp.php'>No</a></div>";
                }
                ...
                if(isset($_GET['del_id'])) {
                    ...
                    $delCamp = new Campus();
                    $rtnDelCamp = $delCamp->DELETE_CAMPUS($id_to_del);
                }
                ?>
            </div>
        </div>
