    ...
    <div class="row">
        <div class="col-md-12 jumbotron">
            <div class="text-center">
                <h2>For Computerized Student</h2>
                <p>
                    <h1>Voting System</h1><br />
                <button class="btn btn-info" id="aboutbtn" onclick="showup()">About the System</button>
                </p>
            </div>
        </div>
    </div>
...
function showup(){
	setTimeout(function(){
		alert('Voting System for Computerized Students');
	},0.5); //0.5 second
}
</script>
