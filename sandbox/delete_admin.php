    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            if(isset($_GET['id'])) {
                ...
                echo "<div class='alert alert-danger'>Are you sure you want to delete selected Admin? <a href='http://localhost/voting_system/sandbox/delete_admin.php?del_id=$admin_id'>Yes</a> | <a href='http://localhost/voting_system/sandbox/add_admin.php'>No</a></div>";
            }
            ...
            if(isset($_GET['del_id'])) {
                ...
                $delAdmin = new Admin();
                $rtnDelAdmin = $delAdmin->DELETE_ADMIN($id_to_del);
            }
            ?>
        </div>
    </div>
